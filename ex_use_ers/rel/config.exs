...
environment :dev do
  ...
  set cookie: :"jO4FO?xM6<cJ:E3:3jIH1g|w!yU5cUTqZEY%)lHeqDU==YfVDPH8^)AokHyJ}|49"
end

environment :prod do
  set include_erts: true
  set include_src: false
  set cookie: :"!Mlz}@]Mrt`kYj`karc5zN[jVbVvq@rfu@7q9QT~R`<QU=EM=hc_HZGjz%aR*7sn"
end
